		...
		<div class="card">
			<div class="card-body login-card-body">
				<div class="d-flex flex-column align-items-center justify-content-center mb-3">
					<img src="../assets/img/logo.jpg" class="mb-3" width="150" height="150">
					<p class="login-box-msg" style="font-weight: bold;">APLIKASI ABSENSI DAN PENGGAJIAN PEGAWAI Sari</p>
				</div>
